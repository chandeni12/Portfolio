  ...
  return (
    <main className="w-full bg-[#eee] text-black ">
      <div className="font-geist flex items-center justify-center gap-2">
        <div
          className="absolute left-1/2 top-[15%] grid -translate-x-1/2 content-start justify-items-center gap-6 text-center text-black">
          <span
      ...
      <div
        ref={gallery}
        className="relative box-border flex h-[175vh] gap-[1vw] overflow-hidden bg-white p-[2vw]">
      ...
      {/* <div
        className="font-geist relative flex items-center justify-center gap-2">
        <div
...
const Column = ({
  ...
  return (
    <motion.div
      className="relative -top-[45%] flex h-full w-1/4 min-w-[250px] flex-col gap-[1vw] first:top-[-45%] [&:nth-child(2)]:top-[-95%] [&:nth-child(3)]:top-[-45%] [&:nth-child(4)]:top-[-75%]"
      style={{ y }}>
      {images.map((src, i) => (
        <div key={i} className="relative h-full w-full overflow-hidden">
          {src && src.endsWith('.mp4') ? (
            ...
            <img src={src} alt="image" className="pointer-events-none object-cover w-full h-full rounded-xl" />
          )}
        </div>
      ))}
    </motion.div>
