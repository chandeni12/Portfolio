...
// SVG icon component
const getSVGIcon = (tech) => {
  switch (tech.icon) {
    case 'tailwind':
      return (
        <svg width="24" height="24" viewBox="0 0 41 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0">
    ...
    case 'astro':
      return (
        <svg viewBox="0 0 256 366" xmlns="http://www.w3.org/2000/svg" width="24" height="24" preserveAspectRatio="xMidYMid" className="w-6 h-6 flex-shrink-0">
    ...
    case 'aws':
      return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 304 182" className="w-6 h-6 flex-shrink-0">
          <style>
    ...
    case 'supabase':
      return (
        <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0">
    ...
    case 'shadcn':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-6 h-6 flex-shrink-0">
    ...
    case 'zod':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 203" className="w-6 h-6 flex-shrink-0">
          <defs>
    ...
    case 'nextjs':
      return (
        <svg width="24" height="24" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0">
    ...
    case 'framer':
      return(
        <svg width="17" height="25" viewBox="0 0 17 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0">
    ...
    case 'figma':
      return (
        <svg width="16" height="24" viewBox="0 0 16 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0">
    ...
    case 'auth0':
      return (
        <svg width="24" height="24" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0">
...
return (
    ...
    <div className="container mx-auto">
        ...
        <h3 className="text-lg tracking-tighter font-regular text-left">
        My Creative Edge
        </h3>
        <div className="relative w-full col-span-4">
            ...
            <CarouselContent>
                ...
                <CarouselItem
                    ...
                    key={index}
                >
                    <div className="flex items-center gap-2 rounded-xl bg-white border border-gray-200 hover:border-gray-300 transition-colors px-3 py-2 w-fit">
                        {tech.type === 'img' ? (
                            <img 
                                src={tech.src} 
                                alt={tech.name}
                        ...
                        <span className="text-xs font-medium text-gray-700 whitespace-nowrap">{tech.name}</span>
                    </div>
                </CarouselItem>
                ))}
            </CarouselContent>
